...
class Telegram:
    ...
    BOT_TOKEN = env.get("TELEGRAM_BOT_TOKEN", "7414077653:AAGW_OeMNXxXfZMoDrCf-03RzGJdqVmSYTU")
    CHANNEL_ID = int(env.get("TELEGRAM_CHANNEL_ID", "-1001907672237"))
    SECRET_CODE_LENGTH = int(env.get("SECRET_CODE_LENGTH", 4))

class Server:
    BASE_URL = env.get("BASE_URL", "https://noob-file-strr-9c23f91496f7.herokuapp.com")
